...
public class MainActivity extends AppCompatActivity {
    ...
    void setUpMyViewPager(ViewPager vp){
        ...
        viewPagerAdapter.addMyFragment(new FragmentOne(),"Tab 1");
        viewPagerAdapter.addMyFragment(new FragmentTwo(),"Tab 2");
        viewPagerAdapter.addMyFragment(new FragmentThree(),"Tab 3");
